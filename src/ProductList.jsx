        ...
        <div>
            ...
            <div className="tag">
               ...
               <a   style={{textDecoration:'none'}}>
                        <div>
                    <h3 style={{color:'white', marginLeft:'2rem'}}> Plants</h3>
                    <i style={{color:'white', marginLeft:'2rem'}}>Where Green Meets Serenity</i>
                    </div>
                    </a>
                </div>
            ...
            <div style={styleObjUl}>
                ...
                <div style={{marginLeft:'2rem'}}> <a href="#" onClick={(e)=>handlePlantsClick(e)} style={styleA}>Plants</a></div>
